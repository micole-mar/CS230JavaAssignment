...
abstract class Shape {
    ...
    // Q1: A protected NestedShape data field named parent which defines the parent of a shape.
    protected NestedShape parent; 
    
    // Q1: A method named getParent() which returns the parent of a shape. The return type is NestedShape.
    public NestedShape getParent() {
        return parent; 
    }
    
    // Q1: A method named setParent(NestedShape s) which takes a nested shape as a parameter and sets the parent of a shape using the given parameter.
    ...
    // getPathToRoot method provided on coderunner
    ...
    // Q1: A method named getPath() which returns the path of a shape from root to the object itself. The method should return an array of Shape objects
    public Shape[] getPath() {
        Shape[] pathToRoot = getPathToRoot(this, 0);
        return pathToRoot;
    }
